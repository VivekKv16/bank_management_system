...
<head>
    ...
    <title>XBank - View Profile</title>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav ms-auto mb-1 mb-lg-0 fs-6 text-center">
                <li class="nav-item ps-4"><a class="nav-link text-dark" href="main.html">Dashboard</a></li>
                <li class="nav-item ps-4"><a class="nav-link text-dark" href="viewProfile.jsp">Profile</a></li>
                <li class="nav-item ps-4"><a class="nav-link text-dark" href="#">Settings</a></li>
                <li class="nav-item ps-4"><a class="nav-link text-dark" href="#">Logout</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<%
    // Retrieve the account info passed by the servlet
...
<div class="container mt-5">
    <div class="card shadow-lg p-4 mx-auto" style="max-width: 450px;">
        <h3 class="text-center mb-4 text-dark">Your Profile</h3>
